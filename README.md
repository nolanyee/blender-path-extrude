...
#### Translation
The translation vectors define how the curve is translated along the path. First the pivot point is translated to the location of the first point in the curve. Thus the first tranlation vector is <img src ="images/ExtrudePath10.jpg" width = "100">.
